...
class TestS11fit(unittest.TestCase):
    ...
    def test_S11fit_f0(self):
        mydata = stanalysis.readdata.readdat(
        ...
        fitres, _, _, _ = stanalysis.S11fit(
            x, z, ftype='A')  # , doplots=False, trimwidth=3., fitwidth=5., margin=51)
        f0 = fitres['f0'].value
        expected_f0 = 8108901094
        self.assertAlmostEqual(
            f0, expected_f0, delta=1, msg='Unexpected resonance frequency')  # delta=1 seems arbitrary?
